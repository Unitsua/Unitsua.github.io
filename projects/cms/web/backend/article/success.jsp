...
<table width="45%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="94%" valign="bottom"><span class="STYLE1"> 网站文章管理</span></td>
                            </tr>
                        </table></td>
    ...
    <tr>
        <td>
            <%--<form action="/backend/channelAdd" method="post">--%>
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
                    <tr>
                        <td width="100" height="20" bgcolor="d3eaef" class="STYLE6" colspan="2" align="center">
                            <div align="center"><span class="STYLE10"><a href="/backend/article">操作成功</a>
                </span></div>
                        </td>
                    </tr>
                </table>
